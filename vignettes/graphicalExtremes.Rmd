...
```{r}
p <- .7
flights_emst_fit <- emst(data = flights$data, p = p, method = "vario")
igraph::V(flights_emst_fit$graph)$name <- names(flights$data)
...
ggplot() +
  ...
  ylab("Empirical")
```
1. Introduce dataset and how to plot connections.
