...
plot(danube_flow, layout = danube$coords_to_plot, edge.arrow.size=.3)
```
...
ggplot() +
  geom_point(aes(x = c(Gamma2chi(my_fit$Gamma)), y = c(Gamma2chi(Gamma_hat)))) +
