...
plot_bic <- function(rholist, bic_values, eglasso_graph){
  ## numeric_vector numeric_vector graph -> ggplot
  ## produce plot with bic vs rho
  
  ggplot(mapping = aes(x = rholist, y = bic_values)) +
  geom_line() +
  ...
  scale_x_continuous(
    ...
    sec.axis = sec_axis(trans=~., breaks = rholist,
                        labels = sapply(eglasso_graph$graph, 
                                        igraph::gsize),
