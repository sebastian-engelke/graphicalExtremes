...
In this and other functions, the argument `p = NULL` implies that the data is already expected to be on MPD scale, and no thresholding is performed.
...
best_Gamma <- eglearn_fit$Gamma[[which.min(logliks_eglearn['bic', ])]]
chi_hat <- emp_chi(Y)
